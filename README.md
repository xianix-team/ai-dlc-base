...
When your team reaches item 17 and has a conventions file in place, you are one session away from full AI-DLC adoption. At that point, copy `repository-agents/process-onboarding-agent/` into your repo and follow the onboarding instructions above — the archaeology path will read what you have already built and extend it rather than starting from scratch.
