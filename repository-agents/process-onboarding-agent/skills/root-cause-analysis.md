...
1. Create a new intent file at `process-onboarding-agent/ops/inception/intents/YYYY-MM-DD-<unix_timestamp>-rca-[slug].md`
...
4. Add to the Open section of `process-onboarding-agent/ops/build/backlog.md` using a reference-style link

**Process fix:**
1. Create an improvement file at `process-onboarding-agent/ops/operate/improvements/YYYY-MM-DD-<unix_timestamp>-rca-[slug].md`
